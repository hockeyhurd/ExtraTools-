...
public class OreFermiteWorldgen extends AbstractWorldGen {
	 ...
	 */
	public OreFermiteWorldgen(Block blockSpawn, Block blockSpawnNether, int chanceofSpawn, int chanceOfSpawn_nether, int minVeinSize, int maxVeinSize, int minY, int maxY) {
