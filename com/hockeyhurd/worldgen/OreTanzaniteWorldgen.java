...
public class OreTanzaniteWorldgen extends AbstractWorldGen {
	 ...
	 */
	public OreTanzaniteWorldgen(Block blockSpawn, Block blockSpawnNether, int chanceofSpawn, int chanceOfSpawn_nether, int minVeinSize, int maxVeinSize, int minY, int maxY) {
